        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center p-8 bg-dusty-rose/10 rounded-2xl">
                <div className="w-16 h-16 bg-orange/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-8">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="bg-orange/20 text-orange px-3 py-1 rounded-full text-sm">정규직</span>
                      <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm">경력 2-5년</span>
                      <span className="bg-moss-green/20 text-moss-green px-3 py-1 rounded-full text-sm">서울</span>
                    </div>
                  </div>
                  <div className="mt-4 lg:mt-0">
                    <p className="text-2xl font-bold text-orange">연봉 4,000만원~</p>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                  ...
                  <div className="mt-4 lg:mt-0">
                    <p className="text-2xl font-bold text-orange">연봉 4,500만원~</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="bg-orange/20 text-orange px-3 py-1 rounded-full text-sm">정규직</span>
                      <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm">경력 2-5년</span>
                      <span className="bg-moss-green/20 text-moss-green px-3 py-1 rounded-full text-sm">전국</span>
                    </div>
                  </div>
                  <div className="mt-4 lg:mt-0">
                    <p className="text-2xl font-bold text-orange">연봉 3,500만원~</p>
                  </div>
                </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center p-6 bg-dusty-rose/10 rounded-2xl">
                <div className="w-16 h-16 bg-orange/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center p-6 bg-moss-green/10 rounded-2xl">
                <div className="w-16 h-16 bg-moss-green/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-moss-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center">
                        <div className="w-8 h-8 bg-moss-green/20 rounded-full flex items-center justify-center mr-3">
                          <span className="text-sm font-bold text-moss-green">2</span>
                        </div>
                        <span>1차 면접 (실무진)</span>
                      </div>
                      <div className="flex items-center">
