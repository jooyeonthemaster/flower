          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                <h3 className="text-2xl font-semibold text-purple-600 mb-6">비즈니스 혜택</h3>
              ...
              {/* 마케팅 지원 */}
              <div className="bg-white rounded-2xl shadow-lg p-8">
                <h3 className="text-2xl font-semibold text-blue-600 mb-6">마케팅 지원</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-blue-500">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-2xl font-semibold text-blue-600">대리점 파트너</h3>
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-purple-600 font-semibold rounded-lg hover:bg-gray-100 transition-colors duration-300"
              >
