          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-blue-50 rounded-2xl p-8">
                <h3 className="text-2xl font-semibold text-blue-800 mb-6">기본 콘텐츠</h3>
              ...
              <div className="bg-purple-50 rounded-2xl p-8">
                <h3 className="text-2xl font-semibold text-purple-800 mb-6">맞춤 콘텐츠</h3>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-center">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <h4 className="font-semibold text-blue-800 mb-2">매일</h4>
                  ...
                  <div className="p-4 bg-purple-50 rounded-lg">
                    <h4 className="font-semibold text-purple-800 mb-2">주간</h4>
                    <ul className="text-sm text-gray-700 space-y-1">
                      <li>• 렌즈 청소</li>
                      <li>• 케이블 연결 상태 확인</li>
                      <li>• 소프트웨어 업데이트 확인</li>
