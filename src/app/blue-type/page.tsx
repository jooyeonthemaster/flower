  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-20">
        {/* 헤더 섹션 */}
        <section className="bg-gradient-to-r from-blue-500 to-blue-600 text-white py-20 border-b-4 border-blue-700">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl p-8 h-96 flex items-center justify-center relative border-2 border-blue-300">
                  <Image
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 rounded-lg p-6 border-2 border-blue-200">
                  <h3 className="text-xl font-semibold text-blue-700 mb-3">가격 정보</h3>
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-blue-100">
                ...
                <h3 className="text-xl font-semibold text-center mb-4 text-blue-700">고해상도 디스플레이</h3>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-blue-100">
                ...
                <h3 className="text-xl font-semibold text-center mb-4 text-blue-700">저전력 설계</h3>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-blue-100">
                ...
                <h3 className="text-xl font-semibold text-center mb-4 text-blue-700">맞춤 설정</h3>
