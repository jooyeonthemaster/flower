...
export default function PreviewSection({
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900/80 to-black/80 border border-blue-500/20 rounded-[1.25rem] p-3 flex flex-col min-h-0 shadow-[0_0_40px_-10px_rgba(59,130,246,0.05)] backdrop-blur-md">
      ...
      <div className="flex-1 flex items-center justify-center bg-black/50 rounded-xl border border-blue-500/10 overflow-hidden p-1.5">
        {previewVideoUrl && (
          <div className="relative w-full h-full flex items-center justify-center">
            <div className="relative w-full max-w-[360px] aspect-square shadow-2xl rounded-xl overflow-hidden ring-1 ring-white/10">
              <CanvasPreview
