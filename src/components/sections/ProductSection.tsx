                ...
                {TEMPLATES_WITH_DATA
                  ...
                  .map((category) => (
                    <button
                      ...
                      className="group bg-white/70 backdrop-blur-sm border-2 border-white/20 p-5 text-center hover:border-blue-400 hover:shadow-lg transition-all duration-300 rounded-2xl transform hover:scale-105"
                    >
