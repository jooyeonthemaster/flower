...
export default function CTASection() {
  return (
    <section className="py-24 bg-gray-900 border-t-4 border-blue-600">
        ...
        <div className="text-center space-y-12">
          ...
          <div className="space-y-6">
            <div className="inline-block">
              <span className="px-4 py-2 bg-blue-600 text-white text-sm font-bold tracking-wider uppercase border-2 border-blue-700">
                START NOW
              </span>
            </div>
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight">
              지금 바로 전문 서비스를<br />
              <span className="text-blue-400">경험하세요</span>
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="space-y-4 p-6 border-2 border-gray-700 bg-gray-800">
                  ...
                  <div className="h-0.5 bg-blue-600 w-12"></div>
            ...
            <div className="bg-gray-800 p-8 border-2 border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                <div className="space-y-2">
                  <div className="text-blue-400 font-bold">■ 대량 주문 할인</div>
                  <div className="text-gray-300 text-sm">10개 이상 주문 시 특별 할인가</div>
                </div>
                <div className="space-y-2">
                  <div className="text-blue-400 font-bold">■ 전담 매니저 배정</div>
                  <div className="text-gray-300 text-sm">기업 전용 계정 관리 서비스</div>
                </div>
                <div className="space-y-2">
                  <div className="text-blue-400 font-bold">■ 맞춤 솔루션 개발</div>
                  <div className="text-gray-300 text-sm">기업 요구사항 맞춤 제작</div>
                </div>
                <div className="space-y-2">
                  <div className="text-blue-400 font-bold">■ 연간 계약 혜택</div>
